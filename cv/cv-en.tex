...
\hypersetup{
  ...
  urlcolor=accent,
  linkcolor=accent,
  pdftitle={Jaren Untuna - Software Engineer - CV},
...
\skillrow{Infrastructure}{Docker, Docker Compose, Terraform, LocalStack, AWS Lambda, Vercel, Git}
\skillrow{Security}{Access control (RBAC), audit trails, API-key authentication, data-protection compliance}
\skillrow{Learning}{Offensive security, Burp Suite, Nmap, Linux internals, OSINT}
